...
<files>
  ...
  <folder name="packages" open>
    ...
    <file name="db"></file>
    <file name="ui"></file>
    <file name="validators"></file>
  </folder>
  <folder name="tooling">
    <file name="eslint"></file>
    <file name="prettier"></file>
    <file name="typescript"></file>
  </folder>
</files>
...
## Links
- [GitHub Repository](https://github.com/fazers/learn-cpp)
- [Issue Tracker](https://github.com/fazers/learn-cpp/issues)
    `,
    isFeature: false,
    githubUrl: "https://github.com/fazers/learn-cpp",
    stack: [
      {
        name: "C++",
      },
