...
export const components: Record<string, React.ComponentType<any> | undefined> =
  {
    ...
    pre: lazy(() => import("@acme/ui/code-block")),
    figcaption: lazy(() => import("@acme/ui/code-block-header")),
    ...
    FolderTree: lazy(() => import("@acme/ui/folder-tree")),
    CodePlayground: lazy(() => import("@acme/ui/code-playground")),
    Youtube: lazy(() => import("@acme/ui/youtube")),
    files: Files,
    folder: Folder,
    file: File,
  };
